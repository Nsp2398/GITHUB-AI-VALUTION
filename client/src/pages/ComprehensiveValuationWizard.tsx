    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              handleInputChange('industry', newIndustry);
              handleInputChange('sub_industry', firstSubIndustry);
            }}
        ...
        <div>
          ...
          <select
            value={valuationData.sub_industry}
            onChange={(e) => handleInputChange('sub_industry', e.target.value)}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500"
            required
          >
            {Object.entries(getSubIndustries(valuationData.industry)).map(([key, name]) => (
